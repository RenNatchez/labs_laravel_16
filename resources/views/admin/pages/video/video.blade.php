...
<div class="w-full mx-auto container">
    ...
    {{-- header end --}}
    <div class="lg:flex">
        <img class="lg:w-2/4 h- w-11/12 mx-auto rounded-lg mb-5" src="{{asset('image/'. $video->miniature)}}" alt="bug">
        <div class="w-2/4 sm:h-12/12 flex lg:flex-col justify-around mx-auto">
            <a href="{{ route('video.show', $video->id) }}" class="mx-auto">
                <button
                    class="bg-purple-400 px-10 lg:px-32  py-5 lg:py-10 mr-3 text-xs lg:text-sm shadow-sm font-semibold tracking-wider text-white rounded-lg">Voir</button>
            </a>
            <a href="{{ route('video.edit', $video->id) }}" class="mx-auto">
                <button
