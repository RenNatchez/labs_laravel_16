        ...
        <form action="{{ route('carousel.update', $carousel->id) }}" method="post" enctype="multipart/form-data"
            ...
            <div class="w-11/12 sm:w-full my-6 mx-auto border-b-2 border-green-400">
                    ...
                    <x-input placeholder='Entrer votre texte' id="texte"
                        ...
                        name="texte" value='{{$carousel->texte}}' required/>
                        @error('texte')
            ...
            <div class="flex w-100 justify-between">
                <div class="flex items-center pt-10 form-group">
                    <input id="start" value='1' name="start" type="checkbox" class="focus:ring-green-400 h-4 w-4 text-green-400 border-gray-300">
                    <label for="start" class="ml-3 block text-sm font-medium text-gray-700">
                        Image de départ
                    </label>
