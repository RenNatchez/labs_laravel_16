            ...
            <table class="w-full whitespace-nowrap">
                <thead>
                    <tr tabindex="0" class="focus:outline-none h-16 w-full text-sm leading-none text-gray-300">
                        <th class="font-normal text-left pl-4">Membre</th>
                ...
                <tbody class="w-full">
                    ...
                    <tr tabindex="0" class="focus:outline-none h-20 text-sm leading-none text-gray-800 bg-white hover:bg-gray-100 border-b border-t border-gray-100">
                        <td class="pl-4 cursor-pointer">
                            <div class="flex items-center">
                                <div class="w-10 h-10">
                                    <img class="w-full h-full" src="{{asset('image/'. $item->photo)}}" alt="user_pic" />
                                </div>
                                <div class="pl-4">
                                    <p class="font-medium">{{$item->nom}} {{$item->prenom}}</p>
                                    <p class="text-xs leading-3 text-gray-600 pt-2">{{$item->poste->nom}}</p>
                                </div>
                            </div>
                        </td>
                        <td class="pl-12">
                        ...
                        <td class="pl-20 w-96">
                            <a href="{{route('verif.membre.edit', $item->id)}}"><button class="bg_green px-6 py-3 rounded-lg">Analyser</button></a>
                        </td>
                    </tr>
                    @empty
