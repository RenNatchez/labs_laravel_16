                ...
                <tbody class="w-full">
                    ...
                    <tr tabindex="0" class="focus:outline-none h-20 text-sm leading-none text-gray-800 bg-white hover:bg-gray-100 border-b border-t border-gray-100">
                        <td class="pl-4 cursor-pointer">
                            <div class="flex items-center">
                                <div class="pl-4">
                                    <p class="font-medium">{{$item->auteur}}</p>
                        ...
                        <td class="pl-12">
                            <p class="font-medium">{{$item->auteur_email}}</p>
                        </td>
                        <td class="pl-20 w-96">
                            <a href="{{route('verif.commentaire.edit', $item->id)}}"><button class="bg_green px-6 py-3 rounded-lg">Analyser</button></a>
                        </td>
                    </tr>
                    @empty
