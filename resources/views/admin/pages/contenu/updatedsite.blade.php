    ...
    <div class="flex items-center justify-between w-full my-4 pl-4 sm:pr-4">
        <div class="mr-6">
            <h2
                ...
                Contenu du site</h2>
            <div class="font-base tracking-tight text-gray-600">Gérer Le contenu du  site, utiliser les parenthése pour  mettre les mots en valeur</div>
        </div>
        ...
        <form action="{{ route('contenu.edit.site', $contenu->id) }}" method="post"
            ...
            <div class="w-11/12 sm:w-full my-6 mx-auto border-b-2 border-green-400">
                ...
                <x-input placeholder='Entrer le titre 1 ' id="titre_1"
                    class="block mt-1 w-full bg-gray-800 text_input py-3" type="texte" name="titre_1"
                    value='{{$contenu->titre_1}}' />
            </div>
            <!-- titre 2 -->
            <div class="w-11/12 sm:w-full my-6 mx-auto border-b-2 border-green-400">
                ...
                <x-input placeholder='Entrer le titre 2 ' id="titre_2"
                    class="block mt-1 w-full bg-gray-800 text_input py-3" type="texte" name="titre_2"
                    value='{{$contenu->titre_2}}' />
            </div>
            <!-- titre 3 -->
            <div class="w-11/12 sm:w-full my-6 mx-auto border-b-2 border-green-400">
                ...
                <x-input placeholder='Entrer le titre 3 ' id="titre_3"
                    class="block mt-1 w-full bg-gray-800 text_input py-3" type="texte" name="titre_3"
                    value='{{$contenu->titre_3}}' />
            </div>
            <!-- titre 4 -->
            <div class="w-11/12 sm:w-full my-6 mx-auto border-b-2 border-green-400">
                ...
                <x-input placeholder='Entrer le titre 4 ' id="titre_4"
                    class="block mt-1 w-full bg-gray-800 text_input py-3" type="texte" name="titre_4"
                    value='{{$contenu->titre_4}}' />
            </div>
            <!-- titre 5 -->
            <div class="w-11/12 sm:w-full my-6 mx-auto border-b-2 border-green-400">
                ...
                <x-input placeholder='Entrer le titre 5 ' id="titre_5"
                    class="block mt-1 w-full bg-gray-800 text_input py-3" type="texte" name="titre_5"
                    value='{{$contenu->titre_5}}' />
            </div>
            <!-- titre 6 -->
            <div class="w-11/12 sm:w-full my-6 mx-auto border-b-2 border-green-400">
                ...
                <x-input placeholder='Entrer le titre 6 ' id="titre_6"
                    class="block mt-1 w-full bg-gray-800 text_input py-3" type="texte" name="titre_6"
                    value='{{$contenu->titre_6}}' />
            </div>
            <!-- titre 7 -->
            <div class="w-11/12 sm:w-full my-6 mx-auto border-b-2 border-green-400">
                ...
                <x-input placeholder='Entrer le titre 7 ' id="titre_7"
                    class="block mt-1 w-full bg-gray-800 text_input py-3" type="texte" name="titre_7"
                    value='{{$contenu->titre_7}}' />
            </div>
            <!-- description 1 -->
            <div class="w-11/12 sm:w-full my-6 mx-auto border-b-2 border-green-400">
                ...
                <textarea placeholder='Contenu' id="description_1" value='{{$contenu->description_1}}'
                    class=" mt-1 w-full bg-gray-800 border-none text_input rounded-lg"
                    type="text" name="description_1">{{$contenu->description_1}}'</textarea>
            </div>
            <!-- description 2 -->
            <div class="w-11/12 sm:w-full my-6 mx-auto border-b-2 border-green-400">
                ...
                <textarea placeholder='description_2' id="contenu" value='{{$contenu->description_2}}'
                    class=" mt-1 w-full bg-gray-800 border-none text_input rounded-lg"
                    type="text" name="description_2">{{$contenu->description_2}}'</textarea>
            </div>
            <!-- description 3 -->
            <div class="w-11/12 sm:w-full my-6 mx-auto border-b-2 border-green-400">
                ...
                <x-input placeholder='Entrer le titre 7 ' id="description_3"
                    class="block mt-1 w-full bg-gray-800 text_input py-3" type="texte" name="description_3"
